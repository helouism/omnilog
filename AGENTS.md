# OmniLog Analytics Engine — AGENTS.md

Shared instructions for every coding agent used on this repo. `CLAUDE.md` imports this
file rather than restating it, so **edit this file** — never keep a second copy of a rule.
