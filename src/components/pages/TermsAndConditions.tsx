    ...
    <div className="flex-grow-1 overflow-auto">
      <div style={{ maxWidth: 'var(--ol-page-max)', margin: '0 auto', padding: '4rem 1.5rem 0' }}>
        ...
        <main>
          ...
          <div className="mb-4">
            <h1 className="mb-1" style={{ fontSize: 'var(--ol-fs-2xl)' }}>Terms &amp; Conditions</h1>
            <span style={{ fontSize: 'var(--ol-fs-xs)', color: 'var(--ol-text-faint)' }}>Last updated: May 2026</span>
          </div>
          ...
          <Section title="3. Disclaimer of Warranties">
            <p>
              OmniLog is provided <Em>"as is"</Em> and <Em>"as available"</Em>,
